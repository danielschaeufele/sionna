...
equalization, and detection, and CFO compensation
such as the :class:`~sionna.phy.ofdm.LSChannelEstimator`, the
:class:`~sionna.phy.ofdm.RZFPrecoder`, the :class:`~sionna.phy.ofdm.LMMSEEqualizer`, the
:class:`~sionna.phy.ofdm.LinearDetector` and the :class:`~sionna.phy.ofdm.CFOCompensator`.
