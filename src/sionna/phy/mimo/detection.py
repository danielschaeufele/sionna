...
class LinearDetector(Block):
    ...
    :param hard_out: If `True`, the detector computes hard-decided bit values
        ...
        Defaults to `False`.
    :param post_equalizer_transformation: Optional block that applies a
        transformation after the equalizer and before the demapper. This can
        be used to apply transform precoding when DFT-s-OFDM is enabled in
        NR PUSCH.
    ...
    def __init__(
        ...
        hard_out: bool = False,
        post_equalizer_transformation: Optional[Callable] = None,
        custom_demapper: Optional[Callable] = None,
        ...
        **kwargs,
        ...
        if custom_demapper is not None:
